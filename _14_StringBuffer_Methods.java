...
public class _14_StringBuffer_Methods {
    ...
    public static void main(String[] args) {
        ...
        //////////////////////////////////////////////////////////////////////////////////////////////////////////////
        // Every method present in StringBuffer is SYNCHRONISED.
        // And hence only 1 thread is allowed to operate on SB object at a time.
        //////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        // 4) public synchronized void setCharAt(int index, char newChar);
        sb.setCharAt(3,'i');
        System.out.println(sb);                 // Shiiam
        sb.setCharAt(3,'v');


        // 5) public synchronized StringBuffer append(String s);
        ...
        // 6) public synchronized StringBuffer insert(int index, String s).
        ...
        // 7) public synchronized StringBuffer delete(int begin, int end) -> it deletes character from begin index to end -1 and returns remaining string.

        System.out.println(sb.delete(13,sb.length()));      // Shivam Shukla

        // 8) public synchronized StringBuffer deleteCharAt(int index); -> to delete single character;
        System.out.println(sb.deleteCharAt(6));             // ShivamShukla

        // 9) public synchronized SB reverse();  -> In string, we do not have reverse() , but in SB we have reverse() to reverse order of characters!
        ...
        // 10) public synchronized void setLength(int length);
        ...
        // 11) public synchronized void ensureCapacity(int capacity);
